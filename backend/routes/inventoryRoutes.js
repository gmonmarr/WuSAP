...
import {
  ...
  getStoreInventoryWithProductsController
...
router.get('/inventory/store/products', verifyToken, getStoreInventoryWithProductsController); // ver inventario de tienda con detalles de productos
