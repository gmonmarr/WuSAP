...
router.put('/product/:id', verifyToken, verifyRoles("admin", "manager"), putProduct); // actualizar un producto
router.delete('/product/:id', verifyToken, verifyRoles("admin", "manager"), deleteProductController); // eliminar un producto
