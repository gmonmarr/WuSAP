...
const Profile = () => {
  return (
    <Grid container direction="column" alignItems="center" justifyContent="center" style={{ height: "100vh", padding: "0 5%" }}>
        <Typography variant="h4" style={{ marginBottom: "1rem", textAlign: "center", fontWeight: "bold", color: "#3f51b5", margin: "2rem"}}>Perfíl</Typography>
